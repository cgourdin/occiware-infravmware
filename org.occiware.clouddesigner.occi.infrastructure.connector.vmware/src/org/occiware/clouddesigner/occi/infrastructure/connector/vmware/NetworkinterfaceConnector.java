 ...
 * Represent a network adapter. (nic).
 */
...
//                            
	...
	public void occiUpdate()
	{
        ...
        // TODO : Change ipAddress, change Mac address, dhcp active/inactive etc.
        // Note: vmName is set with this method.
        VirtualMachine vm = getVirtualMachineFromLinks();
    ...
    /**
     * Get the port group name (port group name), or allocate an
     * vswitch and port group if no network.
     * 
     * @param vm
     * @param netConn
     * @return
